 ...
 <main className="pt-20 max-w-7xl mx-auto mt-8 px-4 sm:px-6 lg:px-8">
  <section className="bg-white rounded-lg shadow-lg p-12 mb-16">
    ...
    <p className="text-lg mb-10 text-gray-600 text-center max-w-2xl mx-auto leading-relaxed">
      ...
      Nabízíme výuku dětí všech věkových kategorii.
    </p>

    <div className="space-y-10">
      <div className="border-l-4 border-orange-500 pl-4">
        <h2 className="text-3xl font-semibold text-red-600">Tenisová tréninková příprava</h2>
        <p className="text-gray-700 mt-4 leading-relaxed">
          Probíhá skupinovou nebo individuální formou v jakémkoliv věku. Jednotlivé tréninky jsou zaměřené na rozvoj 
          pohybových schopností a nácvik techniky na základě správně volených koordinačních cvičení s následným zdokonalováním 
          v soutěžních podmínkách. V hlubším zájmu je možné zařazení do programu závodního tenisu. Tréninky probíhají 
      ...
      <div className="border-l-4 border-orange-500 pl-4">
        ...
        <p className="text-gray-700 mt-4 leading-relaxed">
          Tenis pro děti od 4 do 7 let je zaměřen na rozvoj pohybových schopností. Během přípravy se děti pestrými a všestrannými 
          cvičeními učí první tenisové krůčky formou hry.
        </p>
      </div>

      <div className="border-l-4 border-orange-500 pl-4">
        <h2 className="text-3xl font-semibold text-red-600">Hlavní cíl naší tenisové školy</h2>
        <p className="text-gray-700 mt-4 leading-relaxed">
          Individuální přístup ke každému hráči. Naším cílem je naučit děti nejen dovednostem techniky a taktiky, ale také 
          vést je k rozvoji osobnosti na základě fair play a správné životosprávy. Chceme u dětí vytvořit vztah k tenisu 
          jako celoživotní aktivitě přispívající ke zdravému životnímu stylu.
        </p>
      </div>
      ...
      <div className="border-l-4 border-orange-500 pl-4">
        <h2 className="text-3xl font-semibold text-red-600">Příměstské kempy a soustředění v Malé Skále</h2>
        <p className="text-gray-700 mt-4 leading-relaxed">
          Během prázdnin pořádáme vždy čtyři příměstské kempy a jedno pobytové soustředění pro závodní i rekreační hráče. 
          Děti zde mají možnost zlepšovat své tenisové dovednosti, navazovat nové kamarádské vztahy a užít si spoustu pohybu 
          a zábavy při dalších sportovních aktivitách.
        </p>
      </div>
      ...
      <div className="border-l-4 border-orange-500 pl-4">
        ...
        <p className="text-gray-700 mt-4 leading-relaxed">
          Každoročně pořádáme klubové turnaje pro všechny děti, například Vánoční turnaje a turnaje na závěr letní sezóny. 
          Pro registrované hráče pořádáme turnaje v rámci Českého tenisového svazu.
        </p>
      </div>
      ...
      <div className="border-l-4 border-orange-500 pl-4">
        ...
        <p className="text-gray-700 mt-4 leading-relaxed">
          Tréninky jsou vedeny zkušenými trenéry I., II. a III. třídy s několikaletou praxí a odborným vzděláním pod záštitou 
      ...
      <div className="border-l-4 border-orange-500 pl-4">
        ...
        <p className="text-gray-700 mt-4 leading-relaxed">
          V areálu je menším dětem k dispozici dětské hřiště, pingpongový stůl, basketbalový koš a víceúčelová plocha pro další 
          sportovní aktivity.
        </p>
      </div>
    </div>
